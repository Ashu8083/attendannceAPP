...
async def punch_in_attendance(request: Request,
    ...
    logger.info(f"employee_latitude = {employee_latitude}, employee_longitude = {employee_longitude}")
...
employee_latitude: float,
    ...
    return attendance_service.punch_out_attendance(employee_id = request.state.auth.employee_id,organisation_id = request.state.auth.organisation_id,
                                                             employee_latitude = employee_latitude,
