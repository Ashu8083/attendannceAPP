...
@employee_router.post("/create-employee",response_model=EmployeeResponse,dependencies=[Depends(PermissionChecker("employee.create"))])
def create_employee(
    data : CreateEmployee ,
    request : Request,
...
@employee_router.put("/update-employee-details/{employee_code}",dependencies=[Depends(PermissionChecker("employee.update"))])
def update_employee(
    employee_code :str ,
...
@employee_router.put("/update-employee-status/{employee_code}",dependencies=[Depends(PermissionChecker("employee.update"))])
...
@employee_router.delete("/delete-employee/{employee_code}",dependencies=[Depends(PermissionChecker("employee.delete"))])
def delete_employee(
        employee_code : str,
        employee_service : EmployeeService = Depends(get_employee_service)
):
...
@employee_router.get("/get-all-employees",dependencies=[Depends(PermissionChecker("employee.view"))])
