...
@attendance_manager.get("/abesent-list",dependencies=[Depends(PermissionChecker("attendance.view","ORGANISATION"))])
def absent_list(attendance_date :date ,request : Request,attendance_service : AttendanceService = Depends(get_attendance_service) ):
    ...
    return absent_list
@attendance_manager.post("/mark-absent",response_model=AttendanceResponse,dependencies=[Depends(PermissionChecker("attendance.update","ORGANISATION"))])
...
@attendance_manager.delete("/delete-attendance",response_model=AttendanceResponse,dependencies=[Depends(PermissionChecker("attendance.update","ORGANISATION"))])
