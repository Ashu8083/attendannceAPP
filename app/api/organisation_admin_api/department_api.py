...
@department_router.get("/get-department/{department_name}",response_model=DepartmentResponse, dependencies=[Depends(PermissionChecker("department"))])
...
@department_router.post("/create-department}",response_model=DepartmentResponse,dependencies=[Depends(PermissionChecker("department"))])
...
@department_router.put("/department",response_model=DepartmentResponse,dependencies=[Depends(PermissionChecker("department"))])
...
@department_router.get("/get-all-department",response_model= ListOfDepartment,dependencies=[Depends(PermissionChecker("department"))])
