...
@leave_manage_router.get("/leave-approval/pending", response_model=List[type[LeaveResponseWithEmployeeCode]], dependencies=[Depends(PermissionChecker("leave.view"))])
...
@leave_manage_router.get("/leave-approval/pending/{employee_code}", response_model=LeaveRecordResponseList,dependencies=[Depends(PermissionChecker("leave.view"))])
...
@leave_manage_router.get("/leave-approval/approve/{department}", response_model=LeaveResponseWithEmployeeCode,dependencies=[Depends(PermissionChecker("leave.approve"))])
...
@leave_manage_router.get("/leave-approval/{department_name}", response_model=LeaveResponseWithEmployeeCode,dependencies=[Depends(PermissionChecker("leave.veiw"))])
...
@leave_manage_router.put("/leave-update/{employee_code}", response_model=LeaveResponse,dependencies=[Depends(PermissionChecker("leave.update"))])
